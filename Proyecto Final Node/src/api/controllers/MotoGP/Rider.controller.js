    ...
    try {
        ...
        if(riderById) {
            ...
            const customBody = {
                ...
                nationality: req.body?.nationality ? req.body?.nationality : riderById.req.body?.nationality ,
                ...
                victoriesSeason: req.body?.victoriesSeason ? req.body?.victoriesSeason : riderById.victoriesSeason,
                victoriesCarrer: req.body?.victoriesCarrer ? req.body?.victoriesCarrer : riderById.victoriesCarrer,
