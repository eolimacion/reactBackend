...
PlayerRoutes.post("/", upload.single("image"), [isAuthAdmin], create); //? en medio de la ruta y la función que crea (controlador) está la MIDDLEware, por eso ponemos upload.single, qu ees un método para subir una imagen en concreto.
...
PlayerRoutes.delete("/:id", [isAuthAdmin], deletePlayer);
